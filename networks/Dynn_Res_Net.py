...
from networks.InternalClassifier import InternalClassifier, Flatten
...
class BasicBlockWOutput(nn.Module):
    ...
    def __init__(self, in_channels, channels, params, stride=1):
        ...
        conv_layer = [nn.Conv2d(in_channels, channels, kernel_size=3, stride=stride, padding=1, bias=False),
